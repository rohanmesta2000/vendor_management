	...
	<div type="container">
		<form action="update" class="container" method="post">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="design">
						<label for="id">Id</label><br> <input type="tel" name="id"
							id="id" value="${id}">
					</div>
					<div class="design">
						<label for="category">Category</label><br> <select
							...
							<option value="clothing"
								${product.category == 'clothing' ? 'selected' : ''}>Clothing</option>
							<option value="books"
								${product.category == 'books' ? 'selected' : ''}>Books</option>
							<option value="food"
								${product.category == 'food' ? 'selected' : ''}>Food</option>
							<option value="appliances"
								${product.category == 'appliances' ? 'selected' : ''}>Appliances</option>
							<option value="furniture"
								${product.category == 'furniture' ? 'selected' : ''}>Furniture</option>
						</select>
					</div>
					<br>
					<div class="design">
					...
					<br>
					<div class="design">
						<label for="productPrice">Product Price</label><br> <input
							type="number" name="productPrice" id="productPrice"
				...
				<div class="col">
					<div class="design">
						<label for="deliveryCharge">Delivery Charge</label><br> <input
							type="number" name="deliveryCharge" id="deliveryCharge"
					...
					<br>
					<div class="design">
						<label for="available">Available</label><br> <input
							type="text" name="available" id="available"
							placeholder="Available or not" value="${product.available}">
					</div>
					<br>
				</div>
			</div>
